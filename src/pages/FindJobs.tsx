...
const mockJobs = [
  {
    ...
    tags: ['Digital Marketing', 'Team Leader', 'SEO/SEM'],
  ...
  },
  {
    ...
    salary: '25 - 30 triệu',
    jobType: 'Toàn thời gian',
    tags: ['Brand Strategy', 'Marketing Campaign', 'Product Launch'],
  ...
  },
  {
    ...
    salary: '10 - 13 triệu',
    jobType: 'Toàn thời gian',
    tags: ['Facebook', 'Instagram', 'TikTok', 'Content Planning'],
    postedTime: '1 tuần trước',
    isFeatured: false,
    isHot: false,
  },
  {
    ...
    salary: '18 - 22 triệu',
    jobType: 'Toàn thời gian',
    tags: ['Data Analysis', 'Google Analytics', 'Campaign Tracking'],
    postedTime: '3 ngày trước',
    isFeatured: false,
    isHot: true,
  },
  {
    ...
    salary: '14 - 16 triệu',
    jobType: 'Toàn thời gian',
    tags: ['Email Campaigns', 'A/B Testing', 'Mailchimp'],
  ...
  },
  {
    ...
    salary: '15 - 20 triệu',
    jobType: 'Toàn thời gian',
    tags: ['Google Ads', 'PPC', 'Search Campaigns'],
